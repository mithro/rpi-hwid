...
<!-- Each image carries a pixel width, not width="100%" in a td width="33%":
     PyPI's sanitiser (readme_renderer.clean.ALLOWED_ATTRIBUTES) allows width
     on img but only colspan/rowspan/align on td, so percentage widths left the
     table to size its columns by caption length and every label came out a
     different size. The crops are all 500 x 300, so one width is enough. -->
<table>
<tr>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/rpi5.png" alt="Pi 5, bare header" width="260"><br>Pi 5, bare header</td>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/rpi5-poe-hat.png" alt="Pi 5 wearing a Waveshare PoE M.2 HAT+ (B); its radio is disabled so the wlan MAC cannot be read" width="260"><br>Pi 5 with a Waveshare PoE M.2 HAT+ (B); the radio is disabled, so no wlan MAC</td>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/rpi4-pmod-hat.png" alt="Pi 4 with a Digilent Pmod HAT Adaptor" width="260"><br>Pi 4 with a Digilent Pmod HAT Adaptor</td>
</tr>
<tr>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/rpi3bplus.png" alt="Pi 3B+; the wlan MAC is derived from the eth MAC" width="260"><br>Pi 3B+; the wlan MAC is derived from the eth MAC</td>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/rpi-zero-w-bonnet.png" alt="Pi Zero W with the Waveshare PoE-ETH-USB-HUB-HAT; the bonnet's RTL8152 is its eth MAC" width="260"><br>Pi Zero W with the Waveshare PoE-ETH-USB-HUB-HAT; the bonnet's RTL8152 is its eth MAC</td>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/orange-pi-pc.png" alt="Orange Pi PC; eth MAC derived by U-Boot from the SoC serial, no radio" width="260"><br>Orange Pi PC; eth MAC derived by U-Boot from the SoC serial, no radio</td>
</tr>
<tr>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/netv2.png" alt="NeTV2" width="260"><br>NeTV2, carrying the Device DNA and the name derived from it</td>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/arty.png" alt="Arty A7-35T" width="260"><br>Arty A7-35T, with its Digilent serial and flash part</td>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/acorn.png" alt="Acorn CLE-215+, DNA not yet read" width="260"><br>Acorn CLE-215+, with a line to write the DNA on: it has not been read yet</td>
</tr>
<tr>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/tinytapeout.png" alt="TT06 chip on a TT06+ demo board" width="260"><br>TT06 chip on a TT06+ demo board</td>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/tinytapeout-ihp.png" alt="TTIHP25a chip on a DBv3 demo board; no colours recorded for that shuttle yet" width="260"><br>TTIHP25a on a DBv3 demo board; no colours recorded for that shuttle yet</td>
<td><img src="https://raw.githubusercontent.com/mithro/rpi-hwid/main/docs/examples/usb-asix.png" alt="ASIX AX88179 USB 3.0 gigabit adapter" width="260"><br>ASIX AX88179 USB 3.0 gigabit adapter</td>
</tr>
</table>
